...
import { Color, Group, MathUtils, Matrix4, MeshPhysicalMaterial } from "three";
...
function Face({ dataFace }: { dataFace: any }) {
  ...
  let { face, face2, face3 } = useTexture({
    // good
    face: `/ai/facetexture/image5.png`,

    // good
    face2: `/ai/facetexture/image8.png`,
